...
def run_preprocessing():
    ...
    try:
        ...
        preprocess_creditcard(
            "./data/creditcard.csv", "./data/processed_creditcard.csv"
        )
...
def run_balancing():
    ...
    try:
        ...
        balance_dataset(
            "./data/processed_creditcard.csv", "Class", "./data/balanced", "creditcard"
        )

        # Balance e-commerce data
        logger.info("Balancing e-commerce data...")
        balance_dataset(
            "./data/processed_ecommerce.csv", "class", "./data/balanced", "ecommerce"
        )
...
def main():
    ...
    parser.add_argument(
        "--skip-balancing", action="store_true", help="Skip data balancing"
    )
    parser.add_argument(
        "--skip-training", action="store_true", help="Skip model training"
    )
    parser.add_argument(
        "--skip-explainability", action="store_true", help="Skip SHAP analysis"
    )
    parser.add_argument(
